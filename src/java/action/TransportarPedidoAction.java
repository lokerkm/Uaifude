...
public class TransportarPedidoAction implements Action {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            request.setAttribute("mensagem", pedido.toTransporte());
            ...
            Logger.getLogger(TransportarPedidoAction.class.getName()).log(Level.SEVERE, null, ex);

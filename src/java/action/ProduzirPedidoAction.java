...
public class ProduzirPedidoAction  implements Action {
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws IOException {
       int pedidoId = Integer.parseInt(request.getParameter("pedidoId"));
        ...
        try {
            ...
            request.setAttribute("mensagem", pedido.toProducao());
            ...
            Logger.getLogger(ProduzirPedidoAction.class.getName()).log(Level.SEVERE, null, ex);
